...
## Days Over National PM 2.5 Standard by County Over Time
...
```{r, fig.height = 9, fig.width = 14, echo = F}
bigplot("asthma_older", cut = c(100, 200, 300, 400, 600, 1000))
bigplot("asthma_older")
```

### Pneumonia
```{r, fig.height = 9, fig.width = 14, echo = F}
bigplot("pneumonia", cut = c(50, 150, 250, 350, 450, 550))
bigplot("pneumonia")
```
...
```{r, fig.height = 9, fig.width = 14, echo = F}
bigplot("diabetes_lt", cut = c(0, 10, 20, 30, 45, 65))
bigplot("diabetes_lt")
```

### Diabetes (Uncontrolled)
```{r, fig.height = 9, fig.width = 14, echo = F}
bigplot("diabetes_uc", cut = c(20, 60, 100, 140, 160, 230))
bigplot("diabetes_uc")
```
...
### Perforated Appendix
```{r, fig.height = 9, fig.width = 14, echo = F}
bigplot("perf_appendix", cut = c(15, 25, 35, 50, 100, 700))
