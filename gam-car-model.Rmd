...
```{r testing linearity of spatial and temporal trend for pm25, message = FALSE,warning = FALSE}
...
**2. Outcomes**
```{r testing linearity of spatial and temporal trend for outcomes}

# no plot for EDA: very messy plot
...
```{r function for the car model, message=FALSE,warning=FALSE}
#0. load library
